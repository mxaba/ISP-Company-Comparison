...
function dataSet() {
  const companyObject = [{
          ...
          date: new Date().getFullYear() - 1991,
          users: genUsers(),
      ...
      },
      {
          ...
          date: new Date().getFullYear() - 1993,
          users: genUsers(),
      ...
      },
      {
          ...
          data: "uncapped",
          coverage: "Eastern Cape, Gauteng, KwaZulu-Natal, Limpopo, Mpumalanga, Northern Cape, Western Cape, North West",
          date:  new Date().getFullYear() - 1994,
          users: genUsers(),
          router: 'Installation',
          color: 'green',
      ...
      },
      {
          ...
          data: "uncapped",
          coverage: "Eastern Cape, Gauteng, KwaZulu-Natal, Limpopo, Mpumalanga, Northern Cape, Western Cape, North West",
          date: new Date().getFullYear() - 2016,
          users: genUsers(),
          router: 'Included & Fully installed',
          color: 'grey',
      ...
      },
      {
          ...
          data: "capped",
          coverage: "Eastern Cape, Gauteng, KwaZulu-Natal, Limpopo, Mpumalanga, Northern Cape, Western Cape, North West",
          date: new Date().getFullYear() - 2000,
          users: genUsers(),
          router: 'Included & Plug & Play',
          color: 'Turquoise',
          area: "Atlantic Seaboard, Klipfontein District (Old Cape Flats), City Bowl, Helderberg, Northern Suburbs, South Peninsula, Southern Suburbs, Western Suburbs",
          ...
          data: "capped",
          coverage: "Eastern Cape, Gauteng, KwaZulu-Natal, Limpopo, Mpumalanga, Northern Cape, Western Cape, North West",
          date: new Date().getFullYear() - 2010,
          users: genUsers(),
          router: 'Included & Plug & Play',
          color: 'yellow',
          area: "Atlantic Seaboard, Klipfontein District (Old Cape Flats), City Bowl, Helderberg, Northern Suburbs, South Peninsula, Southern Suburbs, Western Suburbs",
